# >>> (Reminders) <<<
- Reminders to shell execution: [[`exit 0`](./main.files/cmd-retcode=0.log)](main.md#L7)
- Reminders to shell execution: [[`exit 1`](./main.files/cmd-retcode=1.log)](main.md#L8)
